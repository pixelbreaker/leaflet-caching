$(document).ready(function(){
  var BingLayer = L.TileLayer.extend({
    ...
    credentials: "AsXTYlvGm7gWw2wpW4N1woffDL_gpZaEvFnKRQcMFqsqhfFwHqWhaf5Py3qGsPIT",
  ...
  var LayerOS = new BingLayer('/cors/ak.dynamic.t{s}.tiles.virtualearth.net/comp/ch/{q}?mkt=en-GB&it=G,OS,BX,RL&shading=hill&n=z&og=107&key={credentials}&c4w=1', {
